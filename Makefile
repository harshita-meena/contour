...
container: ## Build the Contour container image
	...
	kubectl delete -f /home/hmeena/development/contour/examples/contour/ || true ## will fail on delete of job that has completed
	sleep 5
# Replace YAML image with the newly generated one ..
	git checkout 28ddd28e /home/hmeena/development/contour/examples/contour/03-contour.yaml
	sed -i "s/contour:v1.21.0/contour:$(VERSION)/g" /home/hmeena/development/contour/examples/contour/03-contour.yaml
	kubectl apply -f /home/hmeena/development/contour/examples/contour/
	sleep 2
	kubectl apply -f /home/hmeena/development/contour/examples/example-workload/httpproxy/03-routes/httpproxy-multiple-paths.yaml
	sleep 10
	@./hack/get_logs.sh
...
gl:
	@curl 127.0.0.1:9001/config_dump > /home/hmeena/development/contour/config_dump.yaml
